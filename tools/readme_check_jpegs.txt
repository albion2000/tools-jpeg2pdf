 ...
 * Detecte rapidement les fichiers corrompus.
 ...
 * Executer ce script (deux façons entre autres)
   1. Lancer une console windows dans votre répertoire, et taper 'check_jpegs.py'. Pour cela : 
     ...
     1. Cliquez sur le chemin complet dans l'explorateur, pour le faire apparaitre en surbrillance (sélectionné)
   ...
   1. ou bien (non recommandé) Double clicker sur le fichier 'check_jpegs.py' dans l'explorateur windows. Cette méthode a le défaut que la fenêtre se ferme dès la fin, ce qui ne laisse pas le temps de lire le rapport final. 
